...
namespace Infrastructure.src.Infrastructure;
...
public partial class SchoolDbContext : DbContext
{
    ...
    public virtual DbSet<AnnualFees> AnnualFees { get; set; }

    public virtual DbSet<Enrollments> Enrollments { get; set; }

    public virtual DbSet<Schools> Schools { get; set; }

    public virtual DbSet<ScopeMnt> ScopeMnt { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AnnualFees>(entity =>
        {
            ...
            entity.HasIndex(e => e.StudentId, "ix_annual_fees_student_id");
            ...
            entity.HasOne(d => d.Student).WithMany(p => p.AnnualFees)
                .HasForeignKey(d => d.StudentId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("fk_annual_fees_student");
        });
