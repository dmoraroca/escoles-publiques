...
Captures:
![Login (CA)](/manual/codex_images_real/ca/login-admin.png)
...
Captures:
![Inici (part superior) (CA)](/manual/codex_images_real/ca/inici-top.png)
![Inici (part inferior) (CA)](/manual/codex_images_real/ca/inici-down.png)
...
Captura:
![Escoles: llistat (CA)](/manual/codex_images_real/ca/escoles.png)
...
Captures:
![Escoles: nova (modal) (CA)](/manual/codex_images_real/ca/escoles-crear.png)
...
Captura:
![Escoles: detall (CA)](/manual/codex_images_real/ca/escoles-detall.png)
...
Captura:
![Escoles: editar (CA)](/manual/codex_images_real/ca/escoles-edit.png)
...
Captura:
![Escoles: esborrar (confirmacio) (CA)](/manual/codex_images_real/ca/escoles-esborrar.png)
...
Captura:
![Alumnes: llistat (CA)](/manual/codex_images_real/ca/estudiants.png)
...
Captura:
![Alumnes: nou (modal) (CA)](/manual/codex_images_real/ca/estudiants-crear.png)

### 6.3 Veure detalls
1. A la columna d'accions, prem `Detalls`.

Captura:
![Alumnes: detall (CA)](/manual/codex_images_real/ca/estudiants-detall.png)
...
Captura:
![Alumnes: editar (CA)](/manual/codex_images_real/ca/estudiants-edit.png)
...
Captura:
![Alumnes: esborrar (confirmacio) (CA)](/manual/codex_images_real/ca/estudiants-esborrar.png)
...
Captura:
![Inscripcions: llistat (CA)](/manual/codex_images_real/ca/inscripcions.png)
...
Captura:
![Inscripcions: nova (modal) (CA)](/manual/codex_images_real/ca/inscripcions-crear.png)

### 7.3 Veure detalls
1. A la taula, prem `Detalls`.

Captura:
![Inscripcions: detall (CA)](/manual/codex_images_real/ca/inscripcions-detall.png)
...
Captura:
![Inscripcions: editar (CA)](/manual/codex_images_real/ca/inscripcions-edit.png)
...
Captura:
![Inscripcions: esborrar (confirmacio) (CA)](/manual/codex_images_real/ca/inscripcions-esborrar.png)
...
Captura:
![Quotes: llistat (CA)](/manual/codex_images_real/ca/quotes-anuals.png)
...
Captures:
![Quotes: nova (modal) (CA)](/manual/codex_images_real/ca/quotes-anuals-crear.png)

### 8.3 Veure detalls
1. A la taula, prem `Detalls`.

Captura:
![Quotes: detall (CA)](/manual/codex_images_real/ca/quotes-anuals-detall.png)
...
Captura:
![Quotes: editar (CA)](/manual/codex_images_real/ca/quotes-anuals-edit.png)
...
Captura:
![Quotes: esborrar (confirmacio) (CA)](/manual/codex_images_real/ca/quotes-anuals-esborrar.png)
...
Captura:
![Dashboard (part superior) (CA)](/manual/codex_images_real/ca/dashboard-top.png)
![Dashboard (part inferior) (CA)](/manual/codex_images_real/ca/dashboard-down.png)
