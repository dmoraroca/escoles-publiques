...
Screenshots:
![Login (EN)](/manual/codex_images_real/en/login-admin.png)
...
Screenshots:
![Annual fees: list (EN)](/manual/codex_images_real/en/quotes-anuals.png)
![Annual fees: new (modal) (EN)](/manual/codex_images_real/en/quotes-anuals-crear.png)
![Annual fees: edit (EN)](/manual/codex_images_real/en/quotes-anuals-edit.png)
